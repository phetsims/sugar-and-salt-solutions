...
define( function( require ) {
  ...
  var SodiumNitrateConstants = Object.freeze( { 'NITROGEN_OXYGEN_SPACING': NITROGEN_OXYGEN_SPACING } );
  sugarAndSaltSolutions.register( 'SodiumNitrateConstants', SodiumNitrateConstants );

  return SodiumNitrateConstants;
} );