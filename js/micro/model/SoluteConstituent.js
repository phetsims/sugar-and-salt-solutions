...
define( function( require ) {
  ...
  function SoluteConstituent( model, color, type, hold ) {
    ...
    thisSolute.concentration = new IonConcentration( model, type );
    ...
    thisSolute.concentrationToDisplay = new Property( this.concentration.get() );
    ...
    this.concentration.link( function( newValue, oldValue ) {
      if ( !hold.get() ) {
        ...
        var proposedDisplayValue = thisSolute.concentrationToDisplay.get() + delta;
        var trueValue = thisSolute.concentration.get();
        ...
        thisSolute.concentrationToDisplay.set( newValueToDisplay );
      }
      ...
      else if ( thisSolute.concentration.get() === 0.0 ) {
        thisSolute.concentrationToDisplay.set( 0.0 );
      }
    } );
