...
define( function( require ) {
   ...
   * @constructor
   */
  function BeakerAndShakerView( sugarAndSaltSolutionsModel, layoutBounds, globalState, transform, micro, showBeakerTickLabels ) {
    var thisView = this;
...
//        model.setInputFaucetMetrics( new FaucetMetrics( transform, model, rootNode, inputFaucetNode ) );
    ...
    //Temp test
    thisView.addChild( new BeakerNode( sugarAndSaltSolutionsModel.beaker, transform ) );
